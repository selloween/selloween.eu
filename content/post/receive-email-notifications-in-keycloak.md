...
disqus_identifier = "receive-email-notifications-in-keycloak"
disqus_title = "Receive email notifications from Keycloak using Python and the Keycloak Admin API"
disqus_url = "https://binarize.io/post/receive-email-notifications-in-keycloak/"
+++
